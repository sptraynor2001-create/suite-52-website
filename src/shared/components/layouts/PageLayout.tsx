        ...
        <div style={{
          ...
          {subtitle && (
            <p 
              ref={subtitleRef}
              style={{
                background: 'linear-gradient(90deg, rgba(255, 255, 255, 0.15) 0%, rgba(255, 255, 255, 0.25) 25%, rgba(255, 255, 255, 0.38) 50%, rgba(255, 255, 255, 0.25) 75%, rgba(255, 255, 255, 0.15) 100%)',
